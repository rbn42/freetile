...
* Installing
  Please note pip install direct from source may result bad performance (see here)[https://github.com/JonathonReinhart/scuba/issues/71#issuecomment-238057064].

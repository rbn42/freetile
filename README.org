...
* Getting Started
** Key Bindings
 These are [[https://i3wm.org/][i3-wm]] like key bindings. Please add them to your desktop setting manager or the standalone [[http://www.nongnu.org/xbindkeys/xbindkeys.html][xbindkeys]] ([[freetile.scm][configuration file for xbindkeys]]).

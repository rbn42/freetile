...
* Getting Started
This is an [[https://i3wm.org/][i3-wm]] like key binding. You may want to add it to your desktop setting manager or the standalone [[https://wiki.archlinux.org/index.php/Xbindkeys][xbindkeys]] ([[freetile.scm][config file for xbindkeys]]).
